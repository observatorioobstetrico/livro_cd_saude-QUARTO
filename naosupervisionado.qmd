...
-  `reachability`: É um vetor que armazena os valores de _reachability distance_ de cada ponto.
 
- `core_dist`: É um vetor que contém as distâncias de densidade mínima( _core distance_ ) para cada ponto. 
